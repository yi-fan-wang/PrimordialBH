//
//  lensing_merger_rate.h
//  PBH
//
//  Created by Wang Yifan on 21/03/2017.
//  Copyright © 2017 Wang Yifan. All rights reserved.
//

#ifndef lensing_merger_rate_h
#define lensing_merger_rate_h


#endif /* lensing_merger_rate_h */

double lensing_merger_rate(double z,double fraction,double M_phb_solarunit) // unit: SI
{
    double lensing_mag[6] = {1.02678,1.03139,1.02571,1.03058,1.03055,0.83325};
    double lensing_z[6] = {1,2,3,5,10,20};
    ...
    if(z<10)
        n_dp_dt = n_dp_dt * 1.03;
    else if(z<20)
        n_dp_dt = n_dp_dt * (1.03+(0.83325-1.03)/(20-10)*(z-10));
    return n_dp_dt;
}
